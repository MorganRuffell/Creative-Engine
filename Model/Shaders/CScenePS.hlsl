...
# define SAMPLE_TEX(texName) texName.Sample(defaultSampler, vsOutput.uv)
    ...
    float3 colorSum = 0;
    {
        ...
        colorSum += ApplyAmbientLight( diffuseAlbedo, ao, PixelShaderConst.AmbientColor );
    }
    ...
    colorSum += ApplyDirectionalLight( diffuseAlbedo, specularAlbedo, specularMask, gloss, normal, viewDir, PixelShaderConst.SunDirection, PixelShaderConst.SunColor, vsOutput.shadowCoord, texShadow );
