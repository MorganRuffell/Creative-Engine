...
/// <summary>
/// This the mathematics common file.
/// 
/// The more advanced mathematics that I can't quite understand comes from Microsofts miniengine.
/// 
/// These are all generic as they are designed to be used with any integral types.
/// </summary>
namespace CMath
{
