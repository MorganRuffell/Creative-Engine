...
class CGraphicsPSO : public CBasePipelineStateObject
{
...
public:
    ...
    CGraphicsPSO(const wchar_t* Name = L"Unnamed Graphics CPipelineStateObject");
...
class CComputePSO : public CBasePipelineStateObject
{
    friend class CCommandContext;

public:
    CComputePSO(const wchar_t* Name = L"Unnamed Compute CPipelineStateObject");
