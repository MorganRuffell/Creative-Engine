...
namespace CDirectX
{
	struct CDirectXSupportedFeatures
	{
	...
	class CDirectXTest : public CTestBase
	{
	public:
	...
	private:
        ...
        void DetermineDirectXLevel(CDirectXSupportedFeatures* SupportedFeatures);

        void ShaderModelVersions(CDirectXSupportedFeatures* SupportedFeatures);
