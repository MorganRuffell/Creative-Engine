...
void CTexture::Create2D( size_t RowPitchBytes, size_t Width, size_t Height, DXGI_FORMAT Format, const void* InitialData )
{
    Destroy();
    ...
    CCommandContext::InitializeTexture(*this, 1, &texResource);
...
void CTexture::CreateCube( size_t RowPitchBytes, size_t Width, size_t Height, DXGI_FORMAT Format, const void* InitialData )
{
    Destroy();
...
void CTexture::CreateTGAFromMemory( const void* _filePtr, size_t, bool sRGB )
{
...
bool CTexture::CreateDDSFromMemory( const void* filePtr, size_t fileSize, bool sRGB )
{
    ...
    HRESULT hr = CreateDDSTextureFromMemory( CGraphics::g_Device,
