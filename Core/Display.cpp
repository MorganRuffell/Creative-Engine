...
void Display::DrawGUI()
{
    ...
    ImVec2 FileExplorerSize(2050.0, 540.0);
    ImVec2 FileExplorerPosition(0, 940.0f);
    ...
    if (ImGui::BeginMainMenuBar())
    {
        ...
        if (ImGui::BeginMenu("File"))
        {
            ...
            if (ImGui::BeginMenu("Compile Project"))
            {
                ...
                if (ImGui::MenuItem("Compile All Schematix", "Shift + CTRL + M")) {
                    ImGui::EndMenu();

                }

                if (ImGui::MenuItem("Compile Selected Schematix", "Shift + M")) {
                    ImGui::EndMenu();
            ...
            if (ImGui::BeginMenu("Compile Settings"))
            {
                ...
                if (ImGui::BeginMenu("Build Classes", true)) {
                    ...
                    ImGui::RadioButton("Build Schematix Implementations", false);
            ...
            if (ImGui::BeginMenu("Create New", true)) {
                ...
                if (ImGui::BeginMenu("Code Structures", true)) {
                    ...
                    {
                        if (ImGui::MenuItem("Schematix Data Implementation")) {
                            ImGui::EndMenu();
                        }

                        if (ImGui::MenuItem("Schematix Dynamic Mesh Implementation")) {
                            ImGui::EndMenu();
                        }

                        ImGui::Separator();

                        if (ImGui::MenuItem("Schematix Crescendo")) {
                            ImGui::EndMenu();
                        }

                        if (ImGui::MenuItem("Schematix Cyclone Effect")) {
                            ImGui::EndMenu();
                        }

                        if (ImGui::MenuItem("Schematix Animation Implementation")) {
                            ImGui::EndMenu();
                        }
                        ...
                        if (ImGui::BeginMenu("Schematix AI", false))
                        {
                            if (ImGui::MenuItem("Schematix BrainTree")) {
                                ImGui::EndMenu();
                            }

                            if (ImGui::MenuItem("Schematix BrainData")) {
                                ImGui::EndMenu();
                            }

                            ImGui::Separator();

                            if (ImGui::MenuItem("Schematix BrainExecutor")) {
                                ImGui::EndMenu();
                            }

                            if (ImGui::MenuItem("Schematix BrainResolution")) {
                                ImGui::EndMenu();
                            }

                            if (ImGui::MenuItem("Schematix BrainImprove")) {
                                ImGui::EndMenu();
                            }
                        ...
                        if (ImGui::MenuItem("Schematix Library")) {
                            ImGui::EndMenu();
                        }

                        if (ImGui::MenuItem("Schematix Interface")) {
                            ImGui::EndMenu();
                        }
        ...
        if (ImGui::BeginMenu("Preferences"))
        {
            ...
            if (ImGui::BeginMenu("Connect to Azure DevOps",false))
            {
                ImGui::EndMenu();

            }

            if (ImGui::BeginMenu("Connect to AWS",false))
            {
                ImGui::EndMenu();
            }

            if (ImGui::BeginMenu("Version Control",true))
            {
                if (ImGui::MenuItem("Git"))
                {
                    ImGui::EndMenu();
                }
                if (ImGui::MenuItem("Perforce"))
                {
                    ImGui::EndMenu();
                }
    ...
    if (ImGui::Begin("Engine Controls", &ShowDebug, ImGuiWindowFlags_NoDecoration))
    {
        ImGui::SetWindowPos(EngineInteractionPosition, ImGuiCond_Always);
        ImGui::SetWindowSize(EngineInteractionSize, ImGuiCond_Always);
        ...
        if (ImGui::BeginChild("Controls", { 600.0f, 60.0f }))
        {
            ImGui::PushStyleColor(ImGuiCol_Button, ImVec4{ 0.1f, 0.8f, 0.2f, 1.0f });
            ImGui::PushStyleVar(ImGuiStyleVar_FrameRounding, 10.0f);

            ImGui::Button("Play", { 100.0f, 40.0f });

            ImGui::PopStyleVar();
            ImGui::PopStyleColor();

            ImGui::SameLine();
            ImGui::Button("Stop", { 100.0f, 40.0f });

            ImGui::SameLine();
            ImGui::Button("Pause", { 100.0f, 40.0f });

     
            ImGui::SameLine();
            ImGui::Button("Clean Project", { 90.0f, 40.0f });
        }
        ImGui::EndChild();
    ...
    ImGui::Begin("Details", &ShowDebug, ImGuiWindowFlags_NoDecoration);
    {
        ...
        {
            if (ImGui::BeginTabBar("z", ImGuiTabBarFlags_Reorderable | ImGuiTabBarFlags_NoCloseWithMiddleMouseButton))
            {
                ...
                if (ImGui::BeginTabItem(" Version Control "))
                {
                    ImGui::SetWindowFontScale(1.0f);
                    ImGui::EndTabItem();
                }
                ...
                if (ImGui::BeginTabItem(" Engine Data "))
                {
                    ImGui::SetWindowFontScale(1.0f);
        ...
        ImGui::BeginChild("Inside Details", { 500, 1190 }, true, ImGuiWindowFlags_NoMove);
        {
            ...
            if (ImGui::BeginTabBar("Details", ImGuiTabBarFlags_Reorderable | ImGuiTabBarFlags_NoCloseWithMiddleMouseButton))
            {
                ImGui::SetWindowFontScale(1.2f);
                ...
                if (ImGui::BeginTabItem("Details"))
                {
                    ...
                    ImGui::Button("New Component", { 160.0f, 42.0f });
                    ...
                    ImGui::SameLine();
                    ImGui::Button("Open Schmatix", { 150.0f, 43.0f });

                    ImGui::SameLine();
                    ImGui::Button("Compile Schmatix", { 150.0f, 43.0f });
                ...
                if (ImGui::BeginTabItem("VFX Settings"))
                {
                    ImGui::SetWindowFontScale(1.0f);
                    ImGui::EndTabItem();
                }
    ...
    ImGui::Begin("File Browser", false, ImGuiWindowFlags_NoDecoration || ImGuiWindowFlags_NoBackground);
    {
        ...
        ImGui::BeginChild("Oranges", { 2030.0f, 365.0f }, true, ImGuiWindowFlags_None);
        {
            if (ImGui::BeginTabBar("z", ImGuiTabBarFlags_Reorderable | ImGuiTabBarFlags_NoCloseWithMiddleMouseButton))
            {
                ImGui::SetWindowFontScale(1.3f);
                ...
                if (ImGui::BeginTabItem("Sound Composer"))
                {
                    ImGui::EndTabItem();
                }

                if (ImGui::BeginTabItem("Animation Composer"))
                {
                    ImGui::EndTabItem();
                }
        ...
        if (ImGui::BeginChild("Misc", { 2030.0f, 42.0f }, true, ImGuiWindowFlags_None))
        {
            ImGui::Button("Output Log", { 70.0f, 25.0f });

            ImGui::SameLine();

            ImGui::SameLine();
            ImGui::Button("Cmd", { 70.0f, 25.0f });

            char buffersize[30] = { "Console Command Prompt..." };

            ImGui::SameLine();
            ImGui::InputTextEx("##", "##", buffersize, 0, { 400.0f, 25.0f }, 0, NULL, 0);
