...
//--------------------------------------------------------------------------------------
static HRESULT CreateD3DResources( _In_ ID3D12Device8* d3dDevice,
                                   ...
                                   _In_ bool forceSRGB,
                                   _In_ bool isCubeMap,
                                   _Outptr_opt_ ID3D12Resource2** texture,
...
//--------------------------------------------------------------------------------------
static HRESULT CreateTextureFromDDS( _In_ ID3D12Device8* d3dDevice,
                                     ...
                                     _In_ D3D12_CPU_DESCRIPTOR_HANDLE textureView )
{
...

    {
        ...
        if (SUCCEEDED(hr))
        {
            CGPUResource DestTexture(*texture, D3D12_RESOURCE_STATE_COPY_DEST);
            CCommandContext::InitializeTexture(DestTexture, subresourceCount, initData.get());
        }
    }
