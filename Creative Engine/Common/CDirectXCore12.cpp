...
DX::CDirectXCore12::CDirectXCore12(DXGI_FORMAT backBufferFormat, DXGI_FORMAT depthBufferFormat) :
	m_currentFrame(0),
	m_screenViewport(),
...
void DX::CDirectXCore12::CreateDeviceIndependentResources()
{
}

// Configures the Direct3D device, and stores handles to it and the device context.
void DX::CDirectXCore12::CreateDeviceResources()
{
#if defined(_DEBUG)
...
void DX::CDirectXCore12::CreateWindowSizeDependentResources()
{
...
void DX::CDirectXCore12::UpdateRenderTargetSize()
{
...
void DX::CDirectXCore12::SetWindow(CoreWindow^ window)
{
...
void DX::CDirectXCore12::SetLogicalSize(Windows::Foundation::Size logicalSize)
{
...
void DX::CDirectXCore12::SetDpi(float dpi)
{
	if (dpi != m_dpi)
	{
		m_dpi = dpi;
...
void DX::CDirectXCore12::SetCurrentOrientation(DisplayOrientations currentOrientation)
{
...
void DX::CDirectXCore12::ValidateDevice()
{
...
void DX::CDirectXCore12::Present()
{
...
void DX::CDirectXCore12::WaitForGpu()
{
...
void DX::CDirectXCore12::MoveToNextFrame()
{
	// Schedule a Signal command in the queue.
...
DXGI_MODE_ROTATION DX::CDirectXCore12::ComputeDisplayRotation()
{
...
void DX::CDirectXCore12::GetHardwareAdapter(IDXGIAdapter1** ppAdapter)
{
	ComPtr<IDXGIAdapter1> adapter;
	*ppAdapter = nullptr;
